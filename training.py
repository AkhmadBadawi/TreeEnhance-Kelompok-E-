...
def parse_args():
    ...
    a("num_gen", type=int, default=256, help="number of generation")
...
def main():
    ...
    for gen_count in range(0, numGeneration + 1):
        ...
        print('TRAIN')
        res, step = train(samples, res, optimizer, step, device, writer, train_loss_history, train_L1_history, train_L2_history,args, lambd=args.lambd)
